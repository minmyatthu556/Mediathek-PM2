package de.hawhh.informatik.sml.mediathek.materialien.kunde;
...
import de.hawhh.informatik.sml.mediathek.fachwerte.plz.PLZ;
...
public class KundeTest
{
    ...
    public void getKundennummerTest()
    {
        ...
        Kundennummer kundennummer2 = Kundennummer.get(654321);
    ...
    public KundeTest()
    {
        kunde = new Kunde(Kundennummer.get(123456), "Klaus", "Schmidt");
        kunde.setPLZ(PLZ.get("22761"));
    ...
    {
        assertEquals(Kundennummer.get(123456), kunde.getKundennummer());
