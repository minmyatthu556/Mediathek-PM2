...
public class KundenstammServiceImplTest
{
    ...
    public KundenstammServiceImplTest()
    {
        ...
        _klaus = new Kunde(Kundennummer.get(123456), "Klaus", "Schmidt");
        _susi = new Kunde(Kundennummer.get(654321), "Susi", "Sonnenschein");
    }
    ...
    public void testgetKundenFuerKundennummer()
    {
        ...
        kunde = _kundenstamm.getKunden(Kundennummer.get(987654));
        assertNull(kunde);
    }
